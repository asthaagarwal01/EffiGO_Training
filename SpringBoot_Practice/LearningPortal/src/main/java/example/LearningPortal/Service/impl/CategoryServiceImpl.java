...
//	}
//
//	public CategoryEntity saveCategories(CategoryEntity category) {//change dto
...
//		Optional<CategoryEntity> catOptional = categoryrepo.findById(id);
...
//		//if present then delete else throw id is not present
